...
This folder defines all source code for the 'Demo pipeline' pipeline:
...
* Take a look at the sample under "sample_users_demo_pipeline.py" to get familiar with the syntax.
